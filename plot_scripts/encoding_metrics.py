import pickle
import os
from HiddenStateExtractor.cv2_feature import get_angle_apr, get_aspect_ratio_no_rotation, get_size
...
"""
Dictionary of {<user supplied string/name> : metric function name implemented above}
"""
...
class SingleCellMetrics:
    ...
    # for each metric definition above, implement the dictionary here
