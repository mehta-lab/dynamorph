...
TARGET = '/gpfs/CompMicro/Projects/learningCellState/microglia/segmentation_experiments/expt_003'
...
class Worker(Process):
    ...
    def run(self):
        segmentation_validation_michael(self.inputs, self.gpuid, 'both')
